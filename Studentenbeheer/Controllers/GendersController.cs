...
namespace Studentenbeheer.Controllers
{
    ...
    public class GendersController : ApplicationController
    {
        ...
        public GendersController(ApplicationDbContext context, HttpContextAccessor httpContextAccessor, ILogger<ApplicationController> logger) : base(context, httpContextAccessor, logger)
        {
